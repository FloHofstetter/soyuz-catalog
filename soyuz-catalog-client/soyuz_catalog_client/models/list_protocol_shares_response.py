...
T = TypeVar("T", bound="ListProtocolSharesResponse")


@_attrs_define
class ListProtocolSharesResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for items_item_data in _items:
            items_item = ProtocolShare.from_dict(items_item_data)
        ...
        list_protocol_shares_response = cls(
            items=items,
            next_page_token=next_page_token,
        )

        list_protocol_shares_response.additional_properties = d
        return list_protocol_shares_response
