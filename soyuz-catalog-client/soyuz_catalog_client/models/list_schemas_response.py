...
T = TypeVar("T", bound="ListSchemasResponse")
...
class ListSchemasResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for schemas_item_data in _schemas:
            schemas_item = SchemaInfo.from_dict(schemas_item_data)
        ...
        list_schemas_response = cls(
            schemas=schemas,
            next_page_token=next_page_token,
        )

        list_schemas_response.additional_properties = d
        return list_schemas_response
