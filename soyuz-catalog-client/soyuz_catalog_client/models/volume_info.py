...
class VolumeInfo:
    ...
    define one, and we do not silently extend the spec.
        ...
        Attributes:
            ...
            volume_id (None | str | Unset):
            volume_type (None | str | Unset):
    """
    ...
    volume_id: None | str | Unset = UNSET
    volume_type: None | str | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        volume_id: None | str | Unset
        if isinstance(self.volume_id, Unset):
            volume_id = UNSET
        else:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_volume_id(data: object) -> None | str | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        volume_id = _parse_volume_id(d.pop("volume_id", UNSET))

        def _parse_volume_type(data: object) -> None | str | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        volume_info.additional_properties = d
        return volume_info
