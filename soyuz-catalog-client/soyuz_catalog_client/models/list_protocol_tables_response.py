...
if TYPE_CHECKING:
    from ..models.protocol_table import ProtocolTable


T = TypeVar("T", bound="ListProtocolTablesResponse")


@_attrs_define
class ListProtocolTablesResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for items_item_data in _items:
            items_item = ProtocolTable.from_dict(items_item_data)
        ...
        list_protocol_tables_response = cls(
            items=items,
            next_page_token=next_page_token,
        )

        list_protocol_tables_response.additional_properties = d
        return list_protocol_tables_response
