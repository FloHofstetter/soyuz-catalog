...
T = TypeVar("T", bound="RotateRecipientTokenResponse")
...
class RotateRecipientTokenResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        rotate_recipient_token_response = cls(
            token=token,
        )

        rotate_recipient_token_response.additional_properties = d
        return rotate_recipient_token_response
