...
T = TypeVar("T", bound="ListFunctionsResponse")
...
class ListFunctionsResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for functions_item_data in _functions:
            functions_item = FunctionInfo.from_dict(functions_item_data)
        ...
        list_functions_response = cls(
            functions=functions,
            next_page_token=next_page_token,
        )

        list_functions_response.additional_properties = d
        return list_functions_response
