...
if TYPE_CHECKING:
    from ..models.protocol_schema import ProtocolSchema


T = TypeVar("T", bound="ListProtocolSchemasResponse")


@_attrs_define
class ListProtocolSchemasResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for items_item_data in _items:
            items_item = ProtocolSchema.from_dict(items_item_data)
        ...
        list_protocol_schemas_response = cls(
            items=items,
            next_page_token=next_page_token,
        )

        list_protocol_schemas_response.additional_properties = d
        return list_protocol_schemas_response
