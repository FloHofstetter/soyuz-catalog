...
T = TypeVar("T", bound="ListMetricViewsResponse")


@_attrs_define
class ListMetricViewsResponse:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        metric_views = []
        for metric_views_item_data in self.metric_views:
            metric_views_item = metric_views_item_data.to_dict()
            metric_views.append(metric_views_item)
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        metric_views = []
        _metric_views = d.pop("metric_views")
        for metric_views_item_data in _metric_views:
            metric_views_item = MetricViewInfo.from_dict(metric_views_item_data)
        ...
        list_metric_views_response = cls(
            metric_views=metric_views,
            next_page_token=next_page_token,
        )

        list_metric_views_response.additional_properties = d
        return list_metric_views_response
