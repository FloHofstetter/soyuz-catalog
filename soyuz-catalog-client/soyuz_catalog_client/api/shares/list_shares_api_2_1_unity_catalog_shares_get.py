...
from ...models.list_shares_response import ListSharesResponse
...
) -> HTTPValidationError | ListSharesResponse | None:
    if response.status_code == 200:
        response_200 = ListSharesResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[HTTPValidationError | ListSharesResponse]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        HTTPValidationError | ListSharesResponse
    """
