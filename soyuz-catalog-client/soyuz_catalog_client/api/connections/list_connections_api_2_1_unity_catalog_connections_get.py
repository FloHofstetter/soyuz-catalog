...
from ...models.list_connections_response import ListConnectionsResponse
...
) -> HTTPValidationError | ListConnectionsResponse | None:
    if response.status_code == 200:
        response_200 = ListConnectionsResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[HTTPValidationError | ListConnectionsResponse]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        HTTPValidationError | ListConnectionsResponse
    """
