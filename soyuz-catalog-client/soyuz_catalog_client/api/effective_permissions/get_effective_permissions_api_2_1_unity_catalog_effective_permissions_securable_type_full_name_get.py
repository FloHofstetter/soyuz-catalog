...
from ...models.get_effective_permissions_api_21_unity_catalog_effective_permissions_securable_type_full_name_get_securable_type import (
...
def _get_kwargs(
    securable_type: GetEffectivePermissionsApi21UnityCatalogEffectivePermissionsSecurableTypeFullNameGetSecurableType,
    full_name: str,
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/2.1/unity-catalog/effective-permissions/{securable_type}/{full_name}".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        securable_type (GetEffectivePermissionsApi21UnityCatalogEffectivePermissionsSecurableTypeF
            ullNameGetSecurableType):
        full_name (str):
