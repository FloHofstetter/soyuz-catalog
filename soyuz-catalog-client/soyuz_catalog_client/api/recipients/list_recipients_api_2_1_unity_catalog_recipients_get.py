...
from ...models.list_recipients_response import ListRecipientsResponse
...
) -> HTTPValidationError | ListRecipientsResponse | None:
    if response.status_code == 200:
        response_200 = ListRecipientsResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[HTTPValidationError | ListRecipientsResponse]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        HTTPValidationError | ListRecipientsResponse
    """
