...
from ...models.list_protocol_schemas_response import ListProtocolSchemasResponse
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/delta-sharing/shares/{share}/schemas".format(
...
) -> HTTPValidationError | ListProtocolSchemasResponse | None:
    if response.status_code == 200:
        response_200 = ListProtocolSchemasResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[HTTPValidationError | ListProtocolSchemasResponse]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """List schemas in share (Delta Sharing protocol)
...
def sync(
    ...
    *,
    ...
    Returns:
        HTTPValidationError | ListProtocolSchemasResponse
    """
