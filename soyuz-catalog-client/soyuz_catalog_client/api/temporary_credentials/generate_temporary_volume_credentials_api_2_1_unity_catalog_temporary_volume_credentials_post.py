...
from ...models.generate_temporary_volume_credential import (
...
def _get_kwargs(
    *,
    body: GenerateTemporaryVolumeCredential,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/2.1/unity-catalog/temporary-volume-credentials",
    }
...
def sync_detailed(
    *,
    ...
    """Vend temporary volume credentials
    ...
    Args:
        body (GenerateTemporaryVolumeCredential): Request body for ``POST /temporary-volume-
            credentials``.
