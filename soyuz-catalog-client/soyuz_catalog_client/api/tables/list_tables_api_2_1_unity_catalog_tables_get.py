...
from ...models.list_tables_response import ListTablesResponse
...
) -> HTTPValidationError | ListTablesResponse | None:
    if response.status_code == 200:
        response_200 = ListTablesResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[HTTPValidationError | ListTablesResponse]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        HTTPValidationError | ListTablesResponse
    """
