...
from ...models.list_schemas_response import ListSchemasResponse
...
) -> HTTPValidationError | ListSchemasResponse | None:
    if response.status_code == 200:
        response_200 = ListSchemasResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[HTTPValidationError | ListSchemasResponse]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        HTTPValidationError | ListSchemasResponse
    """
