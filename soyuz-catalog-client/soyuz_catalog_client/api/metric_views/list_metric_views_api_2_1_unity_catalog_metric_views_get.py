...
from ...models.list_metric_views_response import ListMetricViewsResponse
...
) -> HTTPValidationError | ListMetricViewsResponse | None:
    if response.status_code == 200:
        response_200 = ListMetricViewsResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[HTTPValidationError | ListMetricViewsResponse]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        HTTPValidationError | ListMetricViewsResponse
    """
