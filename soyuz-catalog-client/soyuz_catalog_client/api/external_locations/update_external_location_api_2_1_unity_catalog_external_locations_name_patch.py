...
from ...models.update_external_location import UpdateExternalLocation
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        name (str):
        body (UpdateExternalLocation): Request body for ``PATCH /external-locations/{name}``.
