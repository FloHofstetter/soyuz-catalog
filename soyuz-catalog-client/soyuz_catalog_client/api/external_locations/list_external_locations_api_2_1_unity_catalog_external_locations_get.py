...
from ...models.list_external_locations_response import ListExternalLocationsResponse
...
) -> HTTPValidationError | ListExternalLocationsResponse | None:
    if response.status_code == 200:
        response_200 = ListExternalLocationsResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[HTTPValidationError | ListExternalLocationsResponse]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        HTTPValidationError | ListExternalLocationsResponse
    """
